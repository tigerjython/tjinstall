...
class Passenger(Actor):
    ...
    def board(self):
        ...
        if periodic:
            setTitle("Wartezeitparadoxon - Busabfahrten genau alle 6 s. Mittlere Wartezeit: " + str(round(mean, 2)) + " s")
        else:
            setTitle("Wartezeitparadoxon - Busabfahrten zwischen 2 und 10 s. Mittlere Wartezeit: " + str(round(mean, 2)) + " s")
...
periodic = askYesNo("Busabfahrten genau alle 6 s?")
...
doRun()
if periodic:
    setTitle("Wartezeitparadoxon - Busabfahrten genau alle 6 s")
else:
    setTitle("Wartezeitparadoxon - Busabfahrten zwischen 2 s und 10 s")
